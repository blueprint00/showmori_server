...
//    Select 3, 3 from reward where reward_money = 20000;
    ...
    @Query(value = "SELECT reward_money, reward FROM reward WHERE post_id = ?1", nativeQuery = true)
    Stream<Reward_info> getRewardListByPostId(@Param("post_id")Long post_id);
